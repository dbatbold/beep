...
Prebuilt binaries
===============
 Windows: [beep.exe](http://angiud.com/beep/binary/windows/beep.exe) &nbsp; ```MD5: cd722946c5f24e17840f2de5e924025c```<br>
 Linux 64-bit: [beep](http://angiud.com/beep/binary/linux/beep) &nbsp; ```MD5: 6b16a91de966e8f83b698354066bc5ad```
Usage
=====
```
beep [options]
